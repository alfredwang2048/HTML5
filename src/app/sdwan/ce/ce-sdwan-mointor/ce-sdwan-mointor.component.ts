...
import {rate_chart_options, DURATION_OPTIONS } from '../../../model';

@Component({
  selector: 'app-ce-sdwan-mointor',
  templateUrl: './ce-sdwan-mointor.component.html',
  styleUrls: ['./ce-sdwan-mointor.component.styl']
})
export class CeSdwanMointorComponent implements OnInit {
  @Input()
  esn_id: string;
  @Input()
  if_name: string;
  ...
  cellMonitor(start, end, done: (chartOptions) => void, suffix = '') {
    ...
    monitorObj.tags = {esn_id: this.esn_id, if_name: this.if_name};
