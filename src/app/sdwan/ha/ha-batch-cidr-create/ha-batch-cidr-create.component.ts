...
import {HaInventory} from '../../../shared/sdwan';
import {FormArray, FormBuilder, FormGroup, Validators} from '@angular/forms';
import {validatorIP} from '../../../model/utils';

@Component({
  selector: 'app-ha-batch-cidr-create',
  templateUrl: './ha-batch-cidr-create.component.html',
  styleUrls: ['./ha-batch-cidr-create.component.styl']
})
export class HaBatchCidrCreateComponent implements OnInit {
